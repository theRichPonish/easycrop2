...
class CropPredictionForm(forms.ModelForm):
	class Meta():
		...
		labels={
			...
			'Soil_ph_value':'Soil pH value (0-14)',
			'rainfall_in_mm':'Rainfall (average mm per month)',
		}
		widgets = {
...
class CreateAdForm(forms.ModelForm):
	class Meta():
		...
		labels={
					...
					'country_call_code':'Country Call Code and Area Code (First 3 digits of contact number)',
					'contact_Number':"Last 7 digits of Contact Number"
				}
